...
public class FileUtils {
    ...
    synchronized public static void writeToFile(Context context, String fileName, String dirPath, String fileData, Boolean append) {
    ...
    synchronized public static String readFromFile(Context context, String fileName, String dirPath, Boolean newRows) {
        String ret = "";
