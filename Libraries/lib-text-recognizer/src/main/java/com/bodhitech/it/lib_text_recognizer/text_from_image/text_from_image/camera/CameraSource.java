...
public class CameraSource {
     ...
     *
     * @throws RuntimesException if the method fails
     */
    @SuppressLint("InlinedApi")
    private Camera createCamera() {
        ...
        if (mFocusMode != null) {
            if (parameters.getSupportedFocusModes().contains(
                ...
                Log.i(TAG, "This camera focus mode is not supported on this device.");
            }
        }
        ...
        if (mFlashMode != null) {
            if (parameters.getSupportedFlashModes() != null) {
                if (parameters.getSupportedFlashModes().contains(
                    ...
                    Log.i(TAG, "This Camera flash mode:  is not supported on this device.");
                }
            }
        }
            ...
            while (true) {
                synchronized (mLock) {
                    ...
                    outputFrame = new Frame.Builder()
                            .setImageData(mPendingFrameData, mRequestedPreviewWidth,
                                    mRequestedPreviewHeight, ImageFormat.NV21)
